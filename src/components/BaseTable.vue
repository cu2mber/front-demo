...
<template>
  <div>
    <!-- 검색 -->
    <div class="mb-8 flex justify-center items-center gap-2 w-full max-w-2xl mx-auto">
        <BaseInput
          v-model="searchQuery"
          type="text"
        ...
        <button
          type="button"
          class="h-[48px] px-5 text-sm text-white bg-mainNavy-800 hover:bg-mainNavy-900 focus:outline-none focus:ring-4 focus:ring-mainNavy-300 font-medium rounded-xl transition-colors duration-200"
        >
          검색
        </button>
    </div>
    ...
    <!-- 테이블 -->
    <table class="w-full table-auto border-t border-b border-gray-200 text-center">
      <thead>
